  ...
  return (
    <div>
      ...
      <div class="input-group mb-3 mt-5 d-flex justify-content-center">
        ...
        <input className='w-50 d-flex' type="text"  placeholder="Email Address" aria-label="Username" aria-describedby="basic-addon1"/>
      </div>
      <div className='d-flex justify-content-center pb-2 w-100'>
        <textarea className='w-75 form-control' id="exampleFormControlTextarea1" rows="3" placeholder="Feel free to leave a message!"></textarea>
      </div>
      <div className='pb-3'>
